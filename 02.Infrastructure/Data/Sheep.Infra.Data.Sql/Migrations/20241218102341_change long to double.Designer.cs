...
namespace Sheep.Infra.Data.Sql.Migrations
{
    ...
    [Migration("20241218102341_change long to double")]
    partial class changelongtodouble
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sheep.Core.Domain.Sheep.Entities.SheepCategoryEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("EndRam_Ewe")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Sheep.Core.Domain.Sheep.Entities.SheepFullPriceEntity", b =>
                {
                    ...
                    b.Property<double?>("PriceSheep")
                        .HasColumnType("float");

                    b.Property<Guid>("SheepId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<double?>("Unabsorbedcosts")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Sheep.Core.Domain.Sheep.Entities.SheepPricePeriodEntity", b =>
                {
                    ...
                    b.ToTable("SheepPricePeriodEntity");
                });
